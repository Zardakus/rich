We need the base chrome components that frame every editor screen - the top navbar and the left sidebar shell. Thesse will be reused and extended in every chapter that follows.
